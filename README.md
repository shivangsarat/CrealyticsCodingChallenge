...
* The product list design is responsive. in case of desktop, 4 products will be displayed in a grid, while in case of mobile only 2 products will be displayed.
---